...
async def main():
    ...
    def on_rx(data):
        ...
        if data == b'toggle\r\n':  # Check if the received data is "toggle"
            print("data is what we want")
            internal_led.value(not led_state)  # Toggle the LED state (on/off)
            led_state = 1 - led_state  # Update the LED state
    webInterface = WebServer('Asus_5C', 'zakarias')
